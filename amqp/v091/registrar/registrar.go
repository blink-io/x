...
type WithRegistrar interface {
	AMQPv091Registrar(context.Context) RegisterFunc
}
...
func (r serviceRegistrar) Connection() *amqp091.Connection {
	return r.c
}

func NewServiceRegistrar(c *amqp091.Connection) ServiceRegistrar {
...
type Registrar interface {
	RegisterToAMQPv091(context.Context, ServiceRegistrar) error
}
...
func (h *registrar[S]) RegisterToAMQPv091(ctx context.Context, r ServiceRegistrar) error {
